// Procedural micropet sprite, original flat-cozy creatures. Deterministic per speciesId:
// the hash picks one of several body archetypes + eye/cheek details, tinted by variant colour.
...
export function Micropet({ speciesId, variantHex = '#C9A3E0', adult = false, size = 56 }: Props) {
 ...
 const dark = shade(variantHex, 0.8)
 const light = shade(variantHex, 1.25)
 ...
 <>
 <circle cx={eyeX + 1.5} cy="34" r="2.6" fill="#3E2B14" />
 <circle cx="40.5" cy="34" r="2.6" fill="#3E2B14" />
 <circle cx={eyeX + 2.2} cy="33.2" r="0.8" fill="#fff" />
 <circle cx="41.2" cy="33.2" r="0.8" fill="#fff" />
 </>
 )
 ...
 case 'bird':
 return <>
 <ellipse cx="33" cy="38" rx="16" ry="15" fill={variantHex} />
 ...
 case 'cloud':
 return <>
 <ellipse cx="33" cy="40" rx="18" ry="12" fill={variantHex} />
 <circle cx="22" cy="36" r="8" fill={variantHex} />
 <circle cx="44" cy="36" r="8" fill={variantHex} />
 <circle cx="33" cy="31" r="9" fill={light} />
 </>
 case 'bug':
 return <>
 <ellipse cx="33" cy="40" rx="14" ry="13" fill={variantHex} />
 ...
 <circle cx="36" cy="36" r="8" fill={variantHex} />
 <circle cx="36" cy="36" r="3.5" fill={dark} />
 <path d="M22 44 q-6 0 -7 -8" stroke={variantHex} strokeWidth="6" fill="none" strokeLinecap="round" />
 <circle cx="15" cy="34" r="1.4" fill="#3E2B14" />
 </>
 case 'cat':
 return <>
 <ellipse cx="33" cy="40" rx="15" ry="14" fill={variantHex} />
 ...
 <path d="M48 46 q8 -2 9 -9" stroke={variantHex} strokeWidth="5" fill="none" strokeLinecap="round" />
 </>
 case 'sprout':
 return <>
 <ellipse cx="33" cy="42" rx="13" ry="12" fill={variantHex} />
 ...
 default: // blob
 return <>
 <ellipse cx="33" cy="39" rx="16" ry="15" fill={variantHex} />
