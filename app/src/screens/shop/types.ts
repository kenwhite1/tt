...
export const ERRORS_RU: Record<string, string> = {
 ...
 stage_locked: 'Эта часть откроется, когда питомец подрастёт',
 plus_required: 'Доступно с подпиской «Шарик Плюс»',
 combo_limit: 'Бесплатно можно сохранить только 2 образа. Больше, с «Шарик Плюс»',
 empty_combo: 'Сначала надень что-нибудь, потом сохраняй образ',
 dye_worn: 'Эту краску питомец сейчас носит, сначала смой её',
